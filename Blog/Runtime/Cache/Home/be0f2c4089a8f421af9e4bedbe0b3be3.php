...
<div class="banner">
  <section class="box">
    <ul class="texts">
      <p style="color:slategray">加了锁的青春，不会再因谁而推开心门。</p>
      <p style="color:slategray">打了死结的青春，捆死一颗苍白绝望的灵魂。</p>
      <p style="color:slategray">一旦拥有了值得托付的人，便可倾尽一生。</p>
      <p style="color:slategray">为自己掘一个坟墓来葬心，红尘一梦，不再追寻。</p>
    </ul>
    <div class="avatar"><a href="#"><span>许国辉</span></a> </div>
  </section>
</div>
<div class="template">
  <div class="box">
    ...
    <ul>
      <li><a href="/"  target="_blank"><img src="/pblog/Public/images/01.jpg"></a><span>仿新浪博客风格・梅――古典个人博客模板</span></li>
      <li><a href="/" target="_blank"><img src="/pblog/Public/images/02.jpg"></a><span>黑色质感时间轴html5个人博客模板</span></li>
      <li><a href="/"  target="_blank"><img src="/pblog/Public/images/03.jpg"></a><span>Green绿色小清新的夏天-个人博客模板</span></li>
      <li><a href="/" target="_blank"><img src="/pblog/Public/images/04.jpg"></a><span>女生清新个人博客网站模板</span></li>
      <li><a href="/"  target="_blank"><img src="/pblog/Public/images/02.jpg"></a><span>黑色质感时间轴html5个人博客模板</span></li>
      <li><a href="/"  target="_blank"><img src="/pblog/Public/images/03.jpg"></a><span>Green绿色小清新的夏天-个人博客模板</span></li>
    </ul>
  </div>
...
<article>
  ...
  <div class="bloglist left">
    ...
    <figure><img src="/pblog/Public/images/001.png"></figure>
    <ul>
